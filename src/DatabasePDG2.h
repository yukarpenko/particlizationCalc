...
private:
 ...
 Bool_t LoadDecays();
 void SortParticles();  // put the good status particles at the beggining of the
                        // list
...
public:
 ...
 Int_t GetNParticles(Bool_t all = kFALSE);  // true - no. of all particles;
                                            // false - no. of good status
                                            // particles
 ...
 void DumpData(
     Bool_t dumpAll = kFALSE);  // print the PDG information in the console
