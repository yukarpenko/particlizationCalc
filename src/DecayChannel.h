...
public:
 ...
 DecayChannel(Int_t mother, Double_t branching, Int_t nDaughters,
              Int_t *daughters);  // explicit constructor
 ...
 Int_t GetDaughterPDG(
     Int_t i);  // i --> must be the zero-based index of daughter
};
